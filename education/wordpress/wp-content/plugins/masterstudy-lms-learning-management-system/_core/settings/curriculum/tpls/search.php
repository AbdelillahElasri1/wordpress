    ...
    <div class="curriculum-search_popup">
        ...
        <div class="curriculum-search_head">
            ...
            <div class="curriculum-search_title">
                <?php esc_html_e('Adding items to section', 'masterstudy-lms-learning-management-system'); ?>
            </div>
        ...
        <div class="curriculum-search_submit">
            <span @click="addItems">
                {{countSelected('<?php esc_html_e('Add {x} selected courses.', 'masterstudy-lms-learning-management-system') ?>')}}
            </span>
        </div>
