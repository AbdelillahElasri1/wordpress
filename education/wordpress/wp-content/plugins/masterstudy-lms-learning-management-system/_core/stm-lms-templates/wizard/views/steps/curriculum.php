<div class="stm_lms_splash_wizard__content_tab"
	...
	<hr/>
	<div class="stm_lms_splash_wizard__field stm_lms_splash_wizard__field_image_radio lesson_style">
		<?php
		STM_LMS_Templates::show_lms_template(
			'wizard/views/field_data',
			array(
				'title' => esc_html__( 'Lesson style', 'masterstudy-lms-learning-management-system' ),
				'desc'  => esc_html__( 'Select the best style option for your lessons.', 'masterstudy-lms-learning-management-system' ),
			)
		);
		?>
		<div class="stm_lms_splash_wizard__field_input">
			...
			STM_LMS_Templates::show_lms_template(
				...
				array(
					'model' => 'wizard.lesson_style',
					'value' => 'default',
					'image' => 'assets/img/wizard/lessons/default@2x_2.png',
			...
			STM_LMS_Templates::show_lms_template(
				...
				array(
					'model' => 'wizard.lesson_style',
					'value' => 'classic',
					'image' => 'assets/img/wizard/lessons/classic@2x.png',
