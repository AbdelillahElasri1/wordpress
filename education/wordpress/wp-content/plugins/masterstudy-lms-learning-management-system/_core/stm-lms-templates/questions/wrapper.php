...
if (!empty($question_id)) $stm_lms_vars['question_id'] = $question_id;
if (!empty($question_view_type)) $stm_lms_vars['question_view_type'] = $question_view_type;
...
if(!empty($user_answer) and !empty($user_answer['correct_answer'])) $correct_answer = true;
