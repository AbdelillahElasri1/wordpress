...
$user_answer['user_answer'] = ( ! empty( $user_answer['user_answer'] ) ) ? explode( ',', $user_answer['user_answer'] ) : [];
...
foreach ( $answers as $answer ) :
	...
	if ( ! in_array( $full_answer, $user_answer ) and $answer['isTrue'] and $show_correct_answer ) {
		$answer_class[] = 'correct_answer';
	}

	$answered = ! empty( array_intersect( [
		'correctly_answered',
		'wrongly_answered'
