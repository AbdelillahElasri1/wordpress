...
class STM_LMS_Subscriptions {
	...
	public static function _use_membership( $user_id, $course_id, $membership_id ) { // phpcs:ignore Squiz.Scope.MethodScope.Missing
		$r = array();
		...
		if ( class_exists( 'STM_LMS_Mails' ) ) {
			...
			STM_LMS_Mails::send_email( 'Course added.', $message, '', array(), 'stm_lms_membership_course_available_for_admin', compact( 'course_title', 'login', 'membership_plan' ) );
			...
			STM_LMS_Mails::send_email( 'Course added to User', $message, $user['email'], array(), 'stm_lms_membership_course_available_for_user', compact( 'course_title', 'membership_plan' ) );
		}
