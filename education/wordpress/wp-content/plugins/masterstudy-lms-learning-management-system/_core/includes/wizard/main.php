...
class STM_LMS_Wizard_Interface {
	...
	public function scripts( $hook ) {
		if ( 'tools_page_stm-lms-wizard' === $hook ) {
			...
			wp_register_script( 'vue-range-slider', STM_LMS_URL . '/assets/vendors/vue-range-slider.min.js', array(), STM_LMS_VERSION, true );
	...
	public function save() {
		...
		$updated = update_option( 'stm_lms_settings', $settings );
