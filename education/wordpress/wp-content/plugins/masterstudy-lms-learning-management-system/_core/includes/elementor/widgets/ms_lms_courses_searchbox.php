...
class MsLmsCoursesSearchbox extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_script( 'ms_lms_courses_searchbox', STM_LMS_URL . '/assets/js/elementor-widgets/course-search-box/course-search-box.js', array( 'jquery', 'elementor-frontend' ), STM_LMS_VERSION, true );
		wp_register_script( 'ms_lms_courses_searchbox_autocomplete', STM_LMS_URL . '/assets/vendors/vue2-autocomplete.js', array( 'elementor-frontend' ), STM_LMS_VERSION, true );
	}
	...
	public function get_script_depends() {
		return array( 'ms_lms_courses_searchbox', 'ms_lms_courses_searchbox_autocomplete' );
	}
